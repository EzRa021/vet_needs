...
export default function DepartmentTable() {
  ...
  useEffect(() => {
    console.log("Active branch:", userDetails);
    console.log("Branch ID:", branchId);
    
    if (userDetails?.branchId && userDetails?.branchId !== branchId) {
      console.log("Setting branch ID to:", userDetails?.branchId);
  ...
  const handleAddDepartment = async () => {
    ...
    try {
      const newDepartment = {
        id: `${userDetails?.branchId}-${Date.now()}`, // Generate unique ID
      ...
      <CardHeader>
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <CardDescription>
              {userDetails
                ? `Manage departments for ${userDetails.branchName}`
          ...
          <div className="flex gap-2">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    disabled={loading || !isOnline || !userDetails}
                    variant="outline"
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button disabled={!userDetails} className="flex items-center gap-2">
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Create a new department for {userDetails?.branchName || "the active branch"}.
                  </DialogDescription>
                </DialogHeader>
