...
const SalesSummary = () => {
  ...
  useEffect(() => {
    const fetchSalesData = async () => {
      console.log("Fetching sales data for branch:", userDetails?.branchId, "date:", date);
      const data = await getDepartmentCategorySales(userDetails?.branchId, date);
    ...
    fetchSalesData();
  }, [userDetails?.branchId, date, getDepartmentCategorySales]);
